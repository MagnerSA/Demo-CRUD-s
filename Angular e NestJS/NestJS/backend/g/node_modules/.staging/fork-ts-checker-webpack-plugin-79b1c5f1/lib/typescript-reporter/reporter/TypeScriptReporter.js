    ...
    return {
        getReport: ({ changedFiles = [], deletedFiles = [] }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!parsedConfiguration) {
                ...
                parsedConfiguration = TypeScriptConfigurationParser_1.parseTypeScriptConfiguration(configuration.configFile, configuration.context, configuration.configOverwrite, Object.assign(Object.assign({}, system), { onUnRecoverableConfigFileDiagnostic: (diagnostic) => {
